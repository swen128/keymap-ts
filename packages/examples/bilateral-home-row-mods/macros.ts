import {behaviors, keys, type KeyPress, type MacroBehavior} from 'keymap-ts';
...
const createHoldMacro = (name: string, modifierKey: KeyPress, layerName: string): MacroBehavior => 
  macro(name)
    .press(modifierKey)
...
const createTapMacro = (name: string, key: KeyPress): MacroBehavior => {
